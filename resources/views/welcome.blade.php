...
<body>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:150px;">
                                            <button data-edit="{{ $task->id }}" data-bs-toggle="modal"
                                                data-bs-target="#editTask" class="btn btn-sm btn-primary edit">Edit</button>
                                            <button data-del="{{ $task->id }}" class="delete btn btn-sm btn-danger">Delete</button>
                                        </td>
                                    </tr>
                                    @endforeach
    ...
    <!-- Edit Modal -->
    <div  class="close modal fade" id="editTask" {{-- data-bs-backdrop="static" --}} data-bs-keyboard="false" tabindex="-1"
